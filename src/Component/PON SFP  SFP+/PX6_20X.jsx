...
import productImg1 from '../../img/products/PON SFP  SFP+/XGSPON_20X_Img.jpg'
...
const PX6_20X = () => { 
  ...
  let PartNumber = "NXOSPP-H2-PX6-20x";
  let productName ="XGSPON Symmetric OLT SFP+ Transceiver Hot Pluggable, Bidi SC, Tx1577nm EML / Rx1270nm APD, SMF 20KM, DDM";
...
<p className='listFeture'>XGSPON upstream signals are in Time Division Multiplex mode</p>
<p className='listFeture'>9.953G continuous mode transmission with 1570nm EML laser transmitter</p>
<p className='listFeture'>9.953G burst-mode receiver with APD-TIA receiver (with RESET, TDM)</p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXO-H2-PX6-20x Small Form Factor Pluggable SFP+ transceivers are compliant with the current SFP+ Multi-Source Agreement (MSA) Specification. The high performance uncooled 1577nm EML transmitter and high sensitivity APD-TIA receiver provides superior
performance for XGSPON applications up to SMF 20km optical links in FTTx projects.
</p>
</div>
</div>
