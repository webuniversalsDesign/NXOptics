...
const GPON_PG4_20B = () => { 
  ...
  let PartNumber = "NXOSPP-E2-PG4-20B";
...
<p className='listFeture'>Compliant with ITU-T G.984.2 GPON OLT B+</p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSPP-E2-PG4-20B Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
Multi-Source Agreement (MSA) Specification. The high performance uncooled 1490nm DFB transmitter and high sensitivity 1310nm APD receiver provide superior performance for GPON ONU Class B+ applications.
