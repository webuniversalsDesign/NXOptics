...
import productImg1 from '../../img/products/1.25G SFP/SFP_Dual_X5DImg.jpg'
...
const Dual_155M_02Di = () => { 

  let PartNumber = "NXOSFP-A7-M13-02Di";
  let productName ="125M / 155M SFP 100BASE-FX Transceiver Hot Pluggable, Duplex LC, 1310nm FP, MMF 2KM, DDM";
...
<p className='listFeture'>Compliant with IEEE802.3u 100BASE-FX
</p>
...
<p className='listFeture'>Fast Ethernet 100BASE-FX @125M
</p>
...
<div className='resp-overflow'>
 ...
 <p>
NXOSFP-A7-M13-02Di Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
Multi-Source Agreement (MSA) Specification. The high
performance uncooled 1310nm FP transmitter and
high sensitivity PIN receiver provide superior performance for Fast Ethernet and SONET OC-3 / SDH STM-1 applications up to MMF 2km optical links.
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-A7-M13-02D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-A7-M13-02Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-A7-M13-02D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>230</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-A7-M13-02Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>260</td>
