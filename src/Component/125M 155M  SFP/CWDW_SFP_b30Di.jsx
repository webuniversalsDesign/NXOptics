...
const CWDW_SFP_b30Di = () => { 

  let PartNumber = "NXOSFP-A7-Cxx-b30Di";
...
<h5>Features</h5>
  ...
  <p className='listFeture'>  Duplex LC connector </p>
   ...
   <p className='listFeture'> Link budget 30dB over SM fiber </p>
   <p className='listFeture'> Link distance 80~100km over SM fiber for 1470~1610nm </p>
