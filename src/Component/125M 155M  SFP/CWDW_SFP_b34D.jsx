...
const CWDW_SFP_b34D = () => { 
  ...
  let PartNumber = "NXOSFP-A7-Cxx-b34D";
  let productName ="125M / 155M SFP CWDM Transceiver Hot Pluggable, Duplex LC, CWDM DFB, SMF 34dB(100~120KM), DDM";
...
<h5>Features</h5>
  ...
  <p className='listFeture'>  Duplex LC connector </p>
   ...
   <p className='listFeture'> Link budget 34dB over SM fiber </p>
   <p className='listFeture'> Link distance 100~120km over SM fiber for 1470~1610nm </p>
...
NXOSFP-A7-Cxx-b34D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
Multi-Source Agreement (MSA) Specification. There
are 18 wavelengths available from 1270nm to 1610nm The high performance uncooled CWDM DFB transmitter and high sensitivity PIN receiver provide superior performance for Fast Ethernet and SONET OC-3 / SDH STM-1 applications up to SMF 34dB budget optical links.
...
{/*         
        <tr>
          <td>Supply Voltage(NXOSFP-A7-Cxx-b34D5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-A7-Cxx-b34D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-A7-Cxx-b34Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current(NXOSFP-A7-Cxx-b34D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current(NXOSFP-A7-Cxx-b34Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
