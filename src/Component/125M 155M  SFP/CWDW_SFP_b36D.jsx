...
const CWDW_SFP_b36D = () => { 
  ...
  let PartNumber = "NXOSFP-A7-Cxx-b36D";
...
NXOSFP-A7-Cxx-b36D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
...
{/*         
        <tr>
          <td>Supply Voltage(NXOSFP-A7-Cxx-b36D5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-A7-Cxx-b36D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-A7-Cxx-b36Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current(NXOSFP-A7-Cxx-b36D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current(NXOSFP-A7-Cxx-b36Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
