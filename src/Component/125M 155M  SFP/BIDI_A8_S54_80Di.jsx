...
import productImg1 from '../../img/products/125M 155M  SFP/A8_S54_80D.jpg';
...
const BIDI_A8_S54_80Di = () => { 

  let PartNumber = "NXOSFP-A8-S54-80Di";
...
<p className='listFeture'>Compatible with IEEE802.3ah 100Base-BX-D Standard</p>
...
<p className='listFeture'>1550nm DFB laser transmitter and 1490nm PIN receiver</p>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
        ...
        <tr>
          <td>Supply Current(NXOSFP-A8-S54-A2D) </td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
...
export default BIDI_A8_S54_80Di;