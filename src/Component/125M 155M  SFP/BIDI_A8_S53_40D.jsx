...
import productImg1 from '../../img/products/125M 155M  SFP/A8_S53_20DImg.jpg'
...
const BIDI_A8_S53_40D = () => { 

  let PartNumber = "NXOSFP-A8-S53-40D  ";
  let productName ="125M / 155M SFP 100BX-D Transceiver Hot Pluggable, Bidi LC, Tx1550nm DFB / Rx1310nm, SMF 40KM, DDM";
...
<p className="listFeture">Compliant with IEEE802.3ah 100BASE-BX10-D</p>
<p className="listFeture">Compatible with SONET OC-3 LR-2 and SDH STM-1 L   1.2</p>
...
<div className='resp-overflow'>
 ...
 <p>NXOSFP-A8-S53-40D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temperature  (NXOSFP-A8-S53-40D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temperature  (NXOSFP-A8-S53-40Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current  (NXOSFP-A8-S53-40D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
        ...
        <tr>
          <td>Supply Current  (NXOSFP-A8-S53-40Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>280</td>
...
export default BIDI_A8_S53_40D;