...
const BIDI_A8_35_20D = () => { 
  ...
  let PartNumber = "NXOSFP-A8-S35-20D";
...
<div className='resp-overflow'>
 ...
 <p>NXOSFP-A8-S35-20D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-A8-S35-20D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-A8-S35-20Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-A8-S35-20D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>230</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-A8-S35-20Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>260</td>
