...
const Dual_155M_S15_A6Di = () => { 

  let PartNumber = "NXOSFP-A7-S15-A6Di";
...
<p className='listFeture'>Link distance 160km over SM fiber</p>
...
<div className='resp-overflow'>
 ...
 <p>
NXOSFP-A7-S15-A6Di Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
Multi-Source Agreement (MSA) Specification. The high
performance uncooled 1550nm DFB transmitter and
high sensitivity PIN receiver provide superior performance for Fast Ethernet and SONET OC-3 / SDH STM-1 applications 
up to SMF 160km optical links.
...
export default Dual_155M_S15_A6Di;