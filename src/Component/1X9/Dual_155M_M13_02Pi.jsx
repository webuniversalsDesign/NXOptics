...
const Dual_155M_M13_02Pi = () => { 

  let PartNumber = "NXO1X9-A1-M13-02Pi";
...
<h5>Features</h5>
    ...
    <p className='listFeture'>    Compliant with IEEE802.3u 100BASE-FX</p>
     <p className='listFeture'>   Industry Standard 1x9 Footprint</p>
    <p className='listFeture'>    1310nm FP laser transmitter</p>
     <p className='listFeture'>   Duplex SC optical connector</p>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>Supply Voltage(NXO1X9-A1-M13-02P) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+4.5</td>
          <td>V</td>
        ...
        <tr>
          <td>Supply Voltage(NXO1X9-A1-M13-02P5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO1X9-A1-M13-02P)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO1X9-A1-M13-02Pi)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current(NXO1X9-A1-M13-02P)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>200</td>
        ...
        <tr>
          <td>Supply Current(NXO1X9-A1-M13-02Pi)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
...
export default Dual_155M_M13_02Pi;