...
const Dual_AM_S15_A0Pi = () => { 

  let PartNumber = "NXO1X9-AM-S15-A0Pi";
  let productName ="125M / 155M 1X9-100ZX100 Transceiver  Duplex SC/FC/ST, 1550nm DFB, SMF 100KM, LVPECL / PECL Signal Detection";
...
<h5>Features</h5>
  ...
  <p className='listFeture'>  Compatible with SDH STM1 L1.2 and SONET OC3 LR-2 </p>
...
<h5 className='pt-5'>Applications</h5>
   ...
   <p className='listFeture'>100BASE-ZX Ethernet
</p>
...
<div className='resp-overflow'>
 ...
 <p>
{PartNumber} 1X9 SIP package style transceivers are compliant with the industrial standard specification. The high performance uncooled 1550nm DFB transmitter and high sensitivity PIN receiver provide superior performance for Fast Ethernet and SDH STM-1 /
SONET OC-3 and applications up to SMF 100km optical links.
...
export default Dual_AM_S15_A0Pi;