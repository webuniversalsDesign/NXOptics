...
import productImg1 from '../../img/products/1X9/155M_dual_3.jpg'
...
import machdimenssion from '../../img/products/1X9/Dual_155M_dimension.jpg';
...
const Dual_155M_AM_M13 = () => { 

  let PartNumber = "NXO1X9-AM-M13-02P";
  let productName ="125M / 155M 1X9-100FX TransceiverDuplex Metal ST, 1310nm FP, MMF 2KM, LVPECL / PECL Signal Detection";
...
<h5>Features</h5>
    ...
    <p className='listFeture'>Compatible with TIA/EIA-785 100BASE-FX
</p>
    ...
    <p className='listFeture'>  1310nm FP laser transmitter
     ...
     <p className='listFeture'> Duplex Metal ST optical connector
</p>
...
NXO1X9-AM-M13-02P 1X9 SIP package style transceivers are compliant with the industrial standard specification. The high performance uncooled 1310nm FP transmitter and high sensitivity PIN receiver provide superior
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>Supply Voltage(F1X9-AM-M13-02P) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+4.5</td>
          <td>V</td>
        ...
        <tr>
          <td>Supply Voltage(F1X9-AM-M13-02P5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO1X9-AM-M13-02P)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO1X9-AM-M13-02Pi)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Voltage (NXO1X9-AM-M13-02P)</td>
          <td>Vcc</td>
          <td>+3.13</td>
          <td>+3.3</td>
          <td>+3.47</td>
        ...
        <tr>
          <td>Supply Voltage (NXO1X9-AM-M13-02P5)</td>
          <td>Vcc</td>
          <td>+4.75</td>
          <td>+5.0</td>
          <td>+5.25</td>
        ...
        <tr>
          <td>Supply Current(NXO1X9-AM-M13-02P)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>200</td>
        ...
        <tr>
          <td>Supply Current(NXO1X9-AM-M13-02Pi)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
...
export default Dual_155M_AM_M13;