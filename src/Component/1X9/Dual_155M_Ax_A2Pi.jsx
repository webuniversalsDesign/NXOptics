...
// import transcrve from '../../img/prodalt="img-not-found"ucts/100G CFP CFP2 CFP4/Transceiver.jpg';
import pinassisment from '../../img/products/1X9/CWDW_pinAssignment.jpg';
// import machdimenssion from '../../img/palt="img-not-found"roducts/1X9/Dual_125M.jpg';
...
const Dual_155M_Ax_A2Pi = () => { 

  let PartNumber = "NXO1X9-Ax-S15-A2Pi";
...
<div id="menu1" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>Supply Voltage(NXO1X9-Ax-S15-A2P) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+4.5</td>
          <td>V</td>
        ...
        <tr>
          <td>Supply Voltage(NXO1X9-Ax-S15-A2P5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO1X9-Ax-S15-A2P)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO1X9-Ax-S15-A2Pi)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current(NXO1X9-Ax-S15-A2P)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current(NXO1X9-Ax-S15-A2Pi)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
...
export default Dual_155M_Ax_A2Pi;