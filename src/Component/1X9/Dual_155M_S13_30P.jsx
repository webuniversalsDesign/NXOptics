...
const Dual_155M_Ax_30P = () => { 

  let PartNumber = "NXO1X9-Ax-S13-30P";
...
<p className='listFeture'>Compliant with SDH STM-1 S1.1 and SONET OC-3 IR1 Standard</p>
 ...
 <p className='listFeture'>   LVPECL/ PECL Signal Detection Output</p>
  <p className='listFeture'>  Wave Solderable and Aqueous Washable</p>
   <p className='listFeture'> Transmission distance of 30km over SM fiber</p>
...
<div className='resp-overflow'>
 ...
 NXO1X9-A1-S13-30P 1x9 SIP package style transceivers are compliant with the industrial standard specification. The high performance uncooled 1310nm FP transmitter and high sensitivity PIN-TIA receiver provide superior performance for SONET OC3/ SDH STM1 and Ethernet applications up to 30km optical links with single mode fiber.
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        {/* <tr>
          <td>Supply Voltage(NXO1X9-Ax-S13-30P5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
...
export default Dual_155M_Ax_30P;