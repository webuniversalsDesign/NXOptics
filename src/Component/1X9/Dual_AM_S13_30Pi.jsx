...
const Dual_AM_S13_30Pi = () => { 

  let PartNumber = "NXO1X9-AM-S13-30Pi";
...
<p className='listFeture'>100Base-LX Fast Ethernet</p>
...
{PartNumber} 1x9 SIP package style transceivers are compliant with the industrial standard specification. The high performance uncooled 1310nm FP transmitter and high sensitivity PIN-TIA receiver 
provide superior performance for SONET OC3/ SDH STM1 and Ethernet applications up to 30km optical links with single mode fiber.
</p>
</div>
</div>
...
export default Dual_AM_S13_30Pi;