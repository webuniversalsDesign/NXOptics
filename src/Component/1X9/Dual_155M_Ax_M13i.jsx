...
// import transcrve from '../../img/products/100G C alt="img-not-found"FP CFP2 CFP4/Transceiver.jpg';
import pinassisment from '../../img/products/1X9/CWDW_pinAssignment.jpg';
// import machdimenssion from '../../img/products/ alt="img-not-found"1X9/Dual_125M.jpg';
...
const Dual_155M_Ax_M13i = () => { 

  let PartNumber = "NXO1X9-Ax-M13-02Pi";
...
<h5>Features</h5>
 ...
 <p className='listFeture'>       Compliant with IEEE802.3u Standard</p>
 ...
 <p className='listFeture'>   LVPECL/ PECL Signal Detection Output</p>
  <p className='listFeture'>  Wave Solderable and Aqueous Washable</p>
   <p className='listFeture'> Transmission distance of 2km over MM fiber</p>
...
export default Dual_155M_Ax_M13i;