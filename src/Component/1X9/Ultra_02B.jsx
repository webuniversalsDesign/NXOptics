...
const Ultra_02B = () => { 
  ...
  let PartNumber = "NXO1X9-05-M85-02B";
...
NXO1X9-05-M85-02B 1X9 SIP package style transceivers are compliant with the industrial standard specification.
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>Supply Voltage(NXO1X9-05-M85-02B) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+4.5</td>
          <td>V</td>
        ...
        <tr>
          <td>Supply Voltage(NXO1X9-05-M85-02B5) </td>
          <td>Vcc</td>
          <td>0</td>
          <td>+6.0</td>
          <td>V</td>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXO1X9-05-M85-02B)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXO1X9-05-M85-02Bi)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
