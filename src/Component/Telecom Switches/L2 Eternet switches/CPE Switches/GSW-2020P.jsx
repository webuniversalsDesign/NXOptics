...
import productImg1 from '../../../../img/products/Telecom Switches/GSW-2020P-img.jpg'

import Navbar from '../../../../Navbar';
import Footer from '../../../../Footer';

import Application from '../../../../img/products/Telecom Switches/GSW-2020P-application.jpg'
...
const GSW_2020P  = () => {
    ...
    let PartNumber = "GSW-2020P";
    let productName = "4x GbE/RJ45 + 1x GbE/RJ45 with PoE+/PSE L2+ Managed Ethernet Switch with Cable Tray (option)";
        ...
        <>
            ...
            <div className='product-struct'>
                ...
                <div className='product-content'>
                   ...
                   <p className='listFeture '> Built-in one PoE+/PSE port for feeding PoE equipment  </p>
                    <p className='listFeture '> Regulated PoE output voltage (52VDC) to stabilize PoE device, and guarantee delivery PoE power distance to 100 meter </p>
                   
                   <p className='listFeture '> Cable diagnostics, measuring cable OK or broken point distance </p>
                ...
                <div className="tab-content">
                    <div id="home" className="container tab-pane active"><br />
                        <div className="container mt-3">
                            ...
                            <p>
                            The GSW-2020P is a new generation CPE switch developed by CTC Union Technologies. This new CPE switch is designed with 4 ports 10/100/1000Base-T RJ45, plus 1 port 10/100/1000Base-T RJ45 with PoE+/PSE for airborne broadband service application. Its design concept is well considered from the basis of stylish and elegant appearance for the residential user as well as the advantage of easy installation for the service provider. Hence, the GSW-2020P makes an Internet connected device no longer like the legacy ones hidden in the corner of household. Oppositely, it can become as an eye-catching furniture to blend into the overall decoration aesthetics at home.
 </p>
                             <p>
                             The GSW-2020P fully supports Layer 2 feature sets with complete network management interfaces such as Web GUI, CLI and SNMP. The GSW-2020P also supports DHCP auto provisioning and TR-069 client function which are suitable for the very large scale deployment from operator or service provider. Both device management features can avoid truck rolls and save OPEX for service providers.
                             </p>
            ...
            <div className='container pt-lg-2 pb-lg-5 pt-2 pb-2'>
                <h1 className='pb-4'>P2MP Airborne Broadband Service Application</h1>
