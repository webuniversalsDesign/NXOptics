...
import Application from '../../../../img/products/Telecom Switches/MSW_202-application.jpg'
import Application2 from '../../../../img/products/Telecom Switches/MSW_202-application2.jpg'
...
const MSW_202   = () => {
    ...
    let PartNumber = "MSW-202";
    let productName = "2x GbE/RJ45 + 2x Dual Rate SFP L2+ Carrier Ethernet Switch (EDD)";
                ...
                <div className="tab-content">
                    <div id="home" className="container tab-pane active"><br />
                        <div className="container mt-3">
                            ...
                            <p>
                            MSW-202 is a carrier class Ethernet Demarcation Device (EDD) with 2x 10/100/1000Base-T Ethernet ports and 2 x 100/1000Base-X dual rate SFP fiber ports which enables EPL (Ethernet Private Line) & EVPL (Ethernet Virtual Private Line) services with advanced carrier Ethernet features per the Metro Ethernet Forum (MEF 9 and 14). By supporting link and service Ethernet OAM schemes, the MSW-202 also provides extensive fault detection and diagnostic capabilities to ensure that actual network use complies with pre-agreed service level agreements (SLAs).
                            </p>
                        </div>
                    </div>
