...
import productImg1 from '../../../img/products/Telecom Switches/GSW-3424MP-img.jpg'

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/Telecom Switches/GSW-3424MP-application.jpg'
...
const GSW_3424MP  = () => {
    ...
    let PartNumber = "GSW-3424MP";
    let productName = "24 x GbE/RJ45 + 4 x 1G SFP with 24 x PoE+ (450W)  L2+ Managed Ethernet Switch";
                        ...
                        <div className='row'>
                            <div className='col-lg-8'>
                                <h5 style={{ fontWeight: "500", fontSize: "16px" }} className='pt-3'> QoS feature</h5>
                                 ...
                                 <p className='listFeture '>Multicast/Broadcast/Unicast storm policing with </p>
                ...
                <div className="tab-content">
                    <div id="home" className="container tab-pane active"><br />
                        <div className="container mt-3">
                            ...
                            <p>
                            The high-density version of managed power over Ethernet switch in best cost performance ratio, GSW-3424MP, is designed for SMB and enterprise network application. Each Ethernet copper port complies with IEEE 802.3at standard to supply 30W power injection maximum. 
                            </p>
                            <p>
                            The GSW-3424MP is equipped with 24× Gigabit RJ45 ports and 4× 1G SFP based fiber optics ports. It is featured completely L2+ switch functionality which guarantees high network availability, secured robust network access and comprehensive QoS in the network edge. Also, the GSW-3424MP can be managed by CTC in-house developed Smartview EMS, which offers a user-friendly and centralized device management platform. It makes the administrators be able to monitor and configure the switches remotely.
                            </p>
                        </div>
                    </div>
