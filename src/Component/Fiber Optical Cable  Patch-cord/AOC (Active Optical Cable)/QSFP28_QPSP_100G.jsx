...
import productImg1 from '../../../img/products/Fiber Optical Cable/AOC/QPSP2.jpg'
...
import pinassisment2 from '../../../img/products/Fiber Optical Cable/AOC/pinAssignment2.jpg';
import machdimenssion from '../../../img/products/Fiber Optical Cable/AOC/dimension6.jpg';
...
const QSFP28_QPSP_100G = () => {

    let PartNumber = "NXOAOC-A0G-QPSP-xxx-xx";
    let productName = "100G QSFP28 Active Optical Cable ( AOC ) Hot Pluggable, 850nm VCSEL, MMF 1~100M, DDM";
    ...
    return (
        <>
            ...
            <p className='listFeture'>     Support InfiniBand QDR, EDR </p>
             ...
             <p className='listFeture'>    Up to 25.78125Gbps data rate per channel </p>
              ...
              <p className='listFeture'>   850nm VCSEL array transmitter </p>
               <p className='listFeture'>  1x100GBASE-SR4 to 4x25GBASE-SR </p>
               <p className='listFeture'>  2-wire interface for management and diagnostic monitor compliant with SFF-8636 ( for 100G ) and SFF-8472 ( for 25G ) </p>
             <p className='listFeture'>    Single 3.3V power supply </p>
              <p className='listFeture'>   Link distance 100m over MM OM4 fiber and 70m over MM OM3 fiber </p>
               <p className='listFeture'>  Low power consumption {"<2.5W"} ( QSFP28 ) </p>
             <p className='listFeture'>    Low power consumption {"<1.0W"} ( SFP28 ) </p>
             <p className='listFeture'>    RoHS Compliant </p>

                    <h5 className='pt-5'>Applications</h5>

                    <p className='listFeture'> 100GBASE-SR4 Ethernet to 4x25GBASE-SR Ethernet Link</p>          
                ...
                <div class="tab-content">
                    <div id="home" class="container tab-pane active"><br />
                        <div class="container mt-3">
                            ...
                            <p>
                                {PartNumber}100G Active Optical Cables (AOC) are direct-attach fiber assemblies with QSFP28 form factor. The AOC utilize multi-mode fiber with 850nm VCSEL and PIN PD. It could be used as an alternative solution to QSFP28 passive and active copper cables, while providing improved signal integrity, longer distances, superior electro-magnetic immunity & better bit error rate performance. They are suitable for 1~100 meters distances and offer a cost-effective way for very high port density connections.
...
<img src={TransceiverBlock} className='sectionImg2_1' alt="Transceiver Block Diagram"/>
            ...
            {/* Memory Map Section Start */}
            <div className='container pt-lg-2 pb-lg-5 pt-2 pb-2'>
                <h1 className='pb-4'>SFP28 Pin Assignment</h1>
...
export default QSFP28_QPSP_100G;