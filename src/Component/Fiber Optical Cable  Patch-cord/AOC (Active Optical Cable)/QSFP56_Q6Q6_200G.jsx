...
import productImg1 from '../../../img/products/Fiber Optical Cable/AOC/Q6Q62.jpg'
...
import machdimenssion from '../../../img/products/Fiber Optical Cable/AOC/dimension11.jpg';
...
const QSFP56_Q6Q6_200G = () => {

    let PartNumber = "NXOAOC-B0G-Q6Q6-xxx-xx";
    let productName = "200G QSFP56 Active Optical Cable ( AOC ) Hot Pluggable, 850nm VCSEL, MMF 1~100M, DDM";
    ...
    return (
        <>
            ...
            <div className='product-struct'>
               ...
               <p className='listFeture'>  Compliant with SFF-8679 4x hardware and electrical specification</p>
             ...
             <p className='listFeture'>    CMIS4.0 management interface </p>
              ...
              <p className='listFeture'>   RoHS Compliant  </p>
                    ...
                    <p className='listFeture'> 200GBASE-SR4 Ethernet </p>
                    
                    <p className='listFeture'> 200Gb/s InfiniBand HDR</p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Power Consumption, per  QSFP56</td>
                                            <td></td>
...
export default QSFP56_Q6Q6_200G;