...
import productImg1 from '../../../img/products/industrialSwitches/Rackmount Switches/IXR-G24044X-24PH.jpeg';
...
import dime1 from '../../../img/products/industrialSwitches/Rackmount Switches/IXR-G24044X-24PH-Dimenssion.jpeg';
...
const IXR_G24044X_24PH = () => {

    let PartNumber = "IXR-G24044X-24PH";
...
P25~P28 <br/>
Per SFP Fiber port:<br/> 100 /1000Base-X Link/Active (Amber)<br/><br/>
P29~P32 <br/>
Per SFP Fiber port:<br/> 1000Base-X Link/Active (Amber) 
...
<div className='resp-overflow'>
 ...
 <p>As an Industrial Layer 3 Ethernet switch for process automation and transportation automation applications, the IXR-G24044X-24PH 
combines data, voice, and video transmissions with high performance and high reliability. The IXR Series has 4x 10G SFP+ slots and 
24x RJ45 GbE ports with PoE features and supports Layer 3 routing functionality to facilitate the deployment of applications across 
networks, making them ideal for large-scale industrial network backbones.
</p>
</div>
</div>
...
export default IXR_G24044X_24PH;
