...
import productImg1 from '../../../img/products/industrialSwitches/Rackmount Switches/ICS-G24044X-24PH.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application1 from '../../../img/products/industrialSwitches/Rackmount Switches/ICS-G24044X-24PH-Application-1.jpeg'
import Application2 from '../../../img/products/industrialSwitches/Rackmount Switches/ICS-G24044X-24PH-Application-2.jpeg'
import dime1 from '../../../img/products/industrialSwitches/Rackmount Switches/ICS-G24044X-24PH-Dimenssion.jpeg';
...
const ICS_G24044X_24PH = () => {

    let PartNumber = "ICS-G24044X-24PH";
...
P25~P28 
Per SFP Fiber port: 100 /1000Base-X Link/Active (Amber)<br/>

P29~P32 
Per SFP+ Fiber port: 1000Base-X Link/Active (Amber) 10GBase-X Link/Active (Blue)</p>
...
<p className='listFeture'> PoE port (P1~P24): PoE ON (Green) </p>
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'>10GbE SFP+:
...
<div className='resp-overflow'>
 ...
 <p>ICS-G24044X-24PH is a hardened L2 managed core switch which also supports PoE+/PSE for rigorous demands of centralize and 
critical applications. ICS-G24044X-24PH supports 4 uplink ports with 10GbE SFP+ and 24 GbE (10/100/1000BaseTX) PoE+ RJ-45 ports 
plus 4 dual speed (100/1000Base-X) SFP fiber optical slots. ICS-G24044X-24PH is an ideal solution for Smart City, surveillance, Intelligent 
traffic control systems and production automation applications and supports up to 24 PoE/PoE+ (IEEE 802.3af/IEEE 802.3at) ports 
which can provide 15.4/30watts power output per port for connecting with heavy-duty industrial PoE devices, such as PTZ IP 
surveillance cameras, high-performance wireless access points, digital signage and IP phones. The ICS-G24044X-24PH is designed 
...
export default ICS_G24044X_24PH;
