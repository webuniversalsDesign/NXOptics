...
import productImg1 from '../../../img/products/industrialSwitches/Emark/IVS-G802T-8PH24.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/industrialSwitches/Emark/IVS-G802T-8PH24-Application.jpeg'
import dime1 from '../../../img/products/industrialSwitches/Emark/IVS-G802T-8PH24-Dimenssion-1.jpeg';
import dime2 from '../../../img/products/industrialSwitches/Emark/IVS-G802T-8PH24-Dimenssion-2.jpeg';
...
const IVS_G802T_8PH24 = () => {

    let PartNumber = "IVS-G802T-8PH24";
    let productName ="10x GbE RJ45 with 8x PoE ,12/24/48VDC , E-Mark";
...
<p className='listFeture '> Provides 8x IEEE 802.3at/af PoE+ output, 30W/per port </p>
...
<p className='listFeture'>Per unit:<br/> Power 1 (Green), Power 2 (Green)</p>
...
laws and directives. CTC IVS-G802T-8PH24 Ethernet switch supports 8 x 1GbE PoE+ ports plus 2 x 1GbE non-PoE ports. With an input 
power range of 12/24/48VDC, this switch is suitable for vehicle battery power supplies and is e-Mark certified to ensure adequate 
safety, meeting all environmental requirements for installation in vehicles.
</p>
</div>
</div>
...
export default IVS_G802T_8PH24;
