...
const IVS802GT = () => {
    ...
    let PartNumber = "IVS-802GT";
    let productName ="8x FE RJ45 and 2x GbE RJ45, E-Mark";
...
laws and directives. CTC IVS-802GT Ethernet switch support 2 x 1GbE ports plus 8 x 10/100Mbps Fast Ethernet ports and has a wide 
-40~75°C operating temperature range. With an input power range of 12/24/48VDC, this switch is suitable for vehicle battery power 
supplies and is e-Mark certified to ensure adequate safety, meeting all environmental requirements for installation in vehicles.
</p>
</div>
</div>
