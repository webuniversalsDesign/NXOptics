...
import Application from '../../../img/products/industrialSwitches/Emark/IVS-802GT-8PH24-application.jpeg'
...
const IVS_802GT_8PH24 = () => {

    let PartNumber = "IVS-802GT-8PH24";
    let productName ="8x FE RJ45 with 8x PoE + 2x GbE RJ45, 12/24/48VDC , E-Mark";
...
<p className='listFeture'>EEE 802.3at PoE+ (Power over Ethernet enhancements)</p>
 </div>
...
&nbsp; &nbsp;  Inactive : OFF
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'>8x 10/100Base-TX RJ45, and 2x 10/100/1000Base-T(X) 
RJ45 auto negotiation speed, Auto MDI/MDI-X 
function, Full/Half duplex  </p>
...
laws and directives. CTC IVS-802GT-8PH24 Ethernet switch supports 8 x 10/100Mbps PoE+ ports plus 2 x 1GbE non PoE ports. With an 
input power range of 12/24/48VDC, this switch is suitable for vehicle battery power supplies and is e-Mark certified to ensure adequate 
...
export default IVS_802GT_8PH24
