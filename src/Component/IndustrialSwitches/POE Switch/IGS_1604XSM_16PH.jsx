...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IGS-1604XSM-16PH.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application1 from '../../../img/products/industrialSwitches/POESwitches/IGS-1604XSM-16PH-Application.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IGS-1604XSM-16PH-Dimenssion.jpeg';
...
const IGS_1604XSM_16PH = () => {

    let PartNumber = "IGS-1604XSM-16PH";
    let productName ="16x 10/100/1000Base-T + 4x GbE/2.5G/5G/10GBase-X SFP+ with 16x PoE 300W";
...
<p className='listFeture '>  Provides 16 port IEEE 802.3af / 802.3at PoE+ output ,30W per port, total 300W </p>
<p className='listFeture '>  Cable diagnostics, identifies opens/shorts distance</p>
<p className='listFeture '>  Provides 5 ring instances that each can support µ-Ring, µ-Chain or Sub-Ring type for flexible uses. Supports up to 5 rings in one device <br/>
...
<p className='listFeture'>Per RJ-45 port: <br/>10/100 Link/Active (Green)<br/>
 1000 Link/Active (Amber)
</p>

<p className='listFeture'>Per SFP Fiber port: <br/>
1G/2.5G Link/Active (Amber) <br/>
10G Link/Active (Blue)
</p>
...
<br/> 	PoE Output Power Off : Off
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'>16x 10/100/1000Base-T RJ-45 + 4x 
100/1000/2.5G/5G/10GBase-X SFP connector<br/>
RJ-45 UTP port supports Auto negotiation speed,
Auto MDI/MDI-X function,<br/>
SFP port supports 1G/2.5G/5G/10G speed with DDMI  </p>
...
<p className='listFeture'>Total PoE Power budge limitation: maximum 300W</p>
...
<div className='resp-overflow'>
 ...
 <p>An Industrial 16-port PoE Gigabit Ethernet switch with 4-port 10 Gigabit SFP+ slot, supporting various types of 10 and 2.5 Gigabit 
optical small form-factor pluggable transceivers for long-distance and wide-bandwidth transmission, each PoE port support 
IEEE802.3af/at standard of the maximum 30W power output, each switch has a total power budget of up to 300Watts, used to 
connect and feed various types of Ethernet power devices, such as smoke sensors, Wi-Fi access points, femtocells, alarm centers, and 
IP cameras. the din-rail and fan less 20-port switch adopts an enhanced and hardened design for high surge protection, wide operating 
temperature and safety certified to meet critical and centralize strict requirements. 
</p>
</div>
</div>
...
export default IGS_1604XSM_16PH;
