...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IGS-402SM-4PU.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/industrialSwitches/POESwitches/IGS-402SM-4PU-Application.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IGS-402SM-4PU-Dimenssion.jpeg';
...
const IGS_402SM_4PU = () => {
    ...
    let PartNumber = "IGS-402SM-4PU";
    let productName ="4x GbE RJ45 + 2x 100/1000Base-X SFP with 4x 60W PoE 240W, 48VDC";
...
<p className='listFeture '> Provides 4-port IEEE 802.3af / 802.3at PoE+ output, 60W per port, total 240W</p>
...
<br/>(Please see CTC µ-Ring white paper for more details and more topology application)</p>
...
PoE Output Power On : ON (Green)
 <br/>
 PoE Fault (Over Load, Short Circuit,Port failed at 
Startup) : Flash 1times /sec (Green) <br/>
 </p>
</div>
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'>  4x 10/100/1000Base-T RJ-45 + 2x 100/1000Base-X SFP 
connector <br/>
RJ-45 UTP port supports Auto negotiation speed,
Auto MDI/MDI-X function,
SFP port supports 100/1000 dual speed with DDMI </p>
...
<div className='resp-overflow'>
 ...
 <p>IGS-402SM-4PU is a managed, industrial grade, L2 Gigabit PoE (Power over Ethernet) switch that provides 4x 10/100/1000Base-T ports 
plus 2x 100/1000Base-X SFP ports with 4x PoE Ports. The PoE features enable power and data to be transferred via a single cable, 
thereby considerably reducing cabling and electrical wiring expenses. Housed in rugged DIN rail or wall mountable IP-30 enclosures, 
these switches are perfect choices for harsh environments, such as industrial networks, intelligent transportation systems (ITS) and are 
also suitable for many military and utility market applications where environmental conditions exceed commercial product 
specifications. The switch can also operate either at standard operating temperature range (-10 to 60°C) or at wide operating 
temperature range (-40 to 75°C) to fulfill the special needs of industrial automation applications.  
</p>
</div>
</div>
