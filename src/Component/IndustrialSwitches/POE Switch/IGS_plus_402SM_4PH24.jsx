...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IGS+402SM-4PH24.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application1 from '../../../img/products/industrialSwitches/POESwitches/IGS+402SM-4PH24-Application-1.jpeg'
import Application2 from '../../../img/products/industrialSwitches/POESwitches/IGS+402SM-4PH24-Application-2.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IGS+402SM-4PH24-Dimenssion.jpeg';
...
const IGS_plus_402SM_4PH24 = () => {

    let PartNumber = "IGS+402SM-4PH24";
    let productName ="4x GbE RJ45 + 2x 100/1000 SFP with 4x PoE 120W, 24/48VDC";
...
<p className='listFeture '> Provides 4x port IEEE 802.3af / 802.3at PoE output (30W per Port)</p>
...
<p className='listFeture'>Per unit:<br/> Power 1 (Green), Power 2 (Green), Fault 
...
<br/> 	PoE Output Power Off : Off
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'>4x 10/100/1000Base-T RJ-45 + 2x FE/GbE SFP slot<br/>
   RJ-45 UTP port support Auto negotiation speed,
Auto MDI/MDI-X function,<br/>
SFP ports support 100/1000M with DDMI   </p>
...
<div className='resp-overflow'>
 ...
 <p>The Gigabit Ethernet switch models are managed industrial grade L2 switches with 4x 10/100/1000Base-T ports and 2x GbE/100M SFP 
...
City, surveillance, Intelligent traffic control systems, production automation applications and support up to 4x PoE/PoE+ (IEEE 802.3af/
IEEE 802.3at) ports which can provide 15.4/30watts power output per port for connecting with heavy-duty industrial PoE devices, 
such as PTZ IP surveillance cameras, high-performance wireless access points, digital signage and IP phones. (See Figure). Standard 
...
export default IGS_plus_402SM_4PH24;
