...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IGS-600-4PH24.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/industrialSwitches/POESwitches/IGS-600-4PH24-Application.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IGS-600-4PH24-Dimenssion-1.jpeg';
...
const IGS_600_4PH24__IGS_402F_4PH24 = () => {

    let PartNumber = "IGS-600-4PH24 & IGS-402F-4PH24";
    let productName ="6x GbE RJ45 with 4x PoE 120W, 24/48VDC || 4x GbE RJ45 + 2x 1000Base Fiber (SC) with 4x PoE 120W, 24/48VDC";
    let productName1 ="6x GbE RJ45 with 4x PoE 120W, 24/48VDC";
    let productName2 ="4x GbE RJ45 + 2x 1000Base Fiber (SC) with 4x PoE 120W, 24/48VDC";
...
• Inactive : OFF<br/>
• Fault : Flash<br/>
(Fault: Over Load, Short Circuit, Port failed at Startup)
</p>
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'>4 x RJ-45(IGS-402F-4PH24)
6 x RJ-45 (IGS-600-4PH24)
10/100/1000Base-T auto negotiation speed, Auto 
MDI/MDI-X function, Full/Half duplex <br/>
2x1000Base-X Fiber connector: SC Muti Mode or 
Single Mode (IGS-402F-4PH24) </p>
...
export default IGS_600_4PH24__IGS_402F_4PH24;
