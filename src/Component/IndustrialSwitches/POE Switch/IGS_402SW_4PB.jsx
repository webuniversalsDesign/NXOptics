...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IGS-402SW-4PB.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/industrialSwitches/POESwitches/IGS-402SW-4PB-Application.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IGS-402SW-4PB-Dimenssion.jpeg';
...
const IGS_402SW_4PB = () => {
    ...
    let PartNumber = "IGS-402SW-4PB";
    let productName ="4x GbE RJ45 + 2x 100/1000Base-X SFP with 4x IEEE802.3bt PoE++ 240W, 48VDC";
...
<p className='listFeture'>Per unit: Power 1 (Green), Power 2 (Green), CPU Act 
(Green)</p>
...
PoE (Green) per port ON :<br/> PoE on<br/>
 Off : PoE off
 </p>
</div>
...
<div className='resp-overflow'>
 ...
 <p>IGS-402SW-4PB is a managed, industrial grade, L2 Gigabit PoE (Power over Ethernet) switch that provides 4x 10/100/1000Base-T ports 
plus 2x 100/1000Base-X SFP ports with IEEE802.3bt PoE++ Ports. The PoE features enable power and data to be transferred via a single 
