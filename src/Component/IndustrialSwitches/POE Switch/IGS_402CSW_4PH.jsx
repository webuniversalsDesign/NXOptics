...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IGS-402CSW-4PH.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

// import Application from '../../../img/products/industrialSwitches/IPS-803GSM/IPS-803GSM-applicatio.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IGS-402CSW-4PH-dimenssion.jpeg';
...
const IGS_402CSW_4PH = () => {

    let PartNumber = "IGS-402CSW-4PH";
    let productName ="4x GbE RJ45 + 2x 100/1000 SFP with 4x PoE 120W, Compact size";
...
PoE Output Power Off : Off </p>
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'> 4x 10/100/1000Base-T RJ-45 + 2x FE/GbE SFP slot
...
<div className='resp-overflow'>
 ...
 <p>These Gigabit Ethernet switch models are managed industrial grade L2 switches with 4 10/100/1000Base-T ports and 2 GbE/100M SFP 
...
City, surveillance, Intelligent traffic control systems, production automation applications and support up to 4 PoE/PoE+ (IEEE 802.3af/
...
such as PTZ IP surveillance cameras, high-performance wireless access points, digital signage and IP phones. Standard operating 
temperature range models (-10 to 60°C) and wide operating temperature range models (-40 to 75°C) fulfill the special needs of 
