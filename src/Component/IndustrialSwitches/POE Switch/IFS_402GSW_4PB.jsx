...
import productImg1 from '../../../img/products/industrialSwitches/POESwitches/IFS-402GSW-4PB.jpeg';

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/industrialSwitches/POESwitches/IFS-402GSW-4PB-application.jpeg'
import dime1 from '../../../img/products/industrialSwitches/POESwitches/IFS-402GSW-4PB-Dimenssion.jpeg';
...
const IFS_402GSW_4PB = () => {

    let PartNumber = "IFS-402GSW-4PB";
    let productName ="4x FE RJ45 + 2x 100/1000Base-X SFP with 4x IEEE802.3bt PoE++ 240W, 48VDC";
...
<p className='listFeture '> Provides 4-port IEEE802.3bt PoE++ output, 90W per port, total 240W</p>
...
<p className='listFeture'>Per unit: Power 1 (Green), Power 2 (Green), CPU Act (Green)</p>
...
PoE (Green) per port ON : PoE on <br/>
Off : PoE off </p>
</div>
 ...
 <h5 style={{fontWeight:"500" , fontSize:"16px"}} className='pt-3'>Network Connector</h5>
   ...
   <p className='listFeture'> 4x10/100Base-TX RJ-45 + 2x 100/1000Base-X SFP 
connector<br/>
...
<div className='resp-overflow'>
 ...
 <p>IFS-402GSW-4PB is a managed, industrial grade, L2 Gigabit PoE (Power over Ethernet) switch that provides 4x10/100Base-TX ports plus 
2x 100/1000Base-X SFP ports with IEEE802.3bt PoE++ Ports. The PoE features enable power and data to be transferred via a single 
...
product specifications. The switch can also operate either at standard operating temperature range (-10 to 60°C) or at wide operating 
