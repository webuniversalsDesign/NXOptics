...
<p className='listFeture'>Compliant with SFF-8665 QSFP56 / QSFP28
MSA</p>
<p className='listFeture'>Compliant with IEEE 802.3bs 200GAUI-4 and 802.3bm CAUI-4 Interface</p>
<p className='listFeture'>Electrical Data Rate up to 56Gbps per Lane</p>
<p className='listFeture'>Hot Pluggable QSFP56 footprint</p>
...
export default TwoHGLoopbackProduct;