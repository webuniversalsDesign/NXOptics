...
<p className='listFeture'>850nm VCSEL transmitter</p>
...
<p className='listFeture'>Link length up to 300m over Multi mode OM3 fiber</p>
<p className='listFeture'>Compliant to IEEE802.3ae 10GBASE-SR</p>
