...
const X2_10G_LR = () => { 
  ...
  let PartNumber = "NXOXF2-H1-S13-10D";
...
<p className='listFeture'>1310nm DFB transmitter</p>
...
<p className='listFeture'>Compliant to IEEE802.3ae 10GBASE-LR</p>
...
<div className='resp-overflow'>
 ...
 <p>NXOXF2-H1-S13-10D is a highly integrated serial optical transponder module for 10Gbit/s data transmission that is usable in typical router line card applications, Storage, IP network and LAN and compliant to X2 MSA. The MUX/DEMUX with clock and data
recovery (CDR), XAUI interface and MDIO
management functions are all integrated into the module. This transceiver uses a 1310nm DFB Laser Diode to achieve 10km over single mode fiber as 10GBASE-LR of the IEEE 802.3ae.
