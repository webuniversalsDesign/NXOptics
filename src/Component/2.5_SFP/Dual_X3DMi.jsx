...
<p className='listFeture'>Compatible with SONET OC-48 SR and SDH
STM-16 I-16
...
<p className='listFeture'>Link distance 300m over MM OM1 fiber and 500m over MM OM2 fiber
...
<p className='listFeture'>Fast Ethernet, Gigabit Ethernet


</p>
<p className='listFeture'>Fiber Channel 1xFC, 2xFC


</p>
<p className='listFeture'>SONET OC3, OC12, OC48


</p>
<p className='listFeture'>SDH STM-1, STM-4, STM-16
...
{PartNumber} Small Form Factor Pluggable SFP transceivers are compliant with the current SFP Multi-Source Agreement (MSA) Specification. The high performance 850nm VCSEL transmitter and
