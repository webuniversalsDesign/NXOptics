...
import mchdimensionImg from '../../img/products/100G QSFP28/ZR4_100GMechdimenssion.jpg'
...
const ZR4_100G = () => {
  let PartNumber = "NXOQ28-K7-L13-80D";
  let productName = "100G QSFP28 ZR4 Transceiver Hot Pluggable, Duplex LC, LAN-WDM EML, SMF 80KM, DDM";
...
<p className='listFeture'>Compliant with IEEE802.3bm 100GBASE-SR4</p>
...
<p className='listFeture'>O-Band LWDM EML transmitter</p>
<p className='listFeture'>SOA + PIN receiver</p>
...
<p className='listFeture'>Link distance 80km over SM fiber with KR4 FEC</p>
<p className='listFeture'>Link distance 60km over SM fiber without FEC</p>
<p className='listFeture'>Maximum Power consumption 6.5W</p>
<p className='listFeture'>RoHS compliant</p>


<h5 className='pt-5'>Applications</h5>

<p className='listFeture'>100GBASE-ZR4 Ethernet</p>
...
<div className='d-flex felx-wrap justify-content-center'>
 ...
 <p>NXOQ28-K7-L13-80D is a 4-Channel LWDM 1300nm
