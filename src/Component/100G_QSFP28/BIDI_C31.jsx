...
const BIDI_C31 = () => {
  let PartNumber = "NXOQ2S-K8-C31-20D"
  let productName = "100G QSFP28 Single Lambda LR1-20-BiDi Transceiver  Hot Pluggable, Bidi LC, Tx1311nm EML / Rx1291nm, SMF 20KM, DDM"
...
<p className='listFeture'>CWDM 1311nm EML transmitter</p>
...
<p className='listFeture'>Link distance 20km over SM fiber with FEC</p>
...
It works based on the 100G Lambda MSA 100G-LR1-20
Standard with the typical center wavelength 1311nm.
The transceiver incorporates one channel optical signal
of 100Gbps(PAM4) from four channels electrical
signal of 25Gbps(NRZ) and vice versa up to SMF 20km
optical links
</p>
</div>
</div>
