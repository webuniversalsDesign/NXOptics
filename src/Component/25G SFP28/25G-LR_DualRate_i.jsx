...
const SFP28_25G_LR_DualRate_i = () => {
  let PartNumber = "NXOSPP-N7-S13-10DRi";
  let productName = "10G / 25G SFP28 LR Transceiver Hot Pluggable, Duplex LC, 1310nm DFB, SMF 10KM, DDM, Dual-Rate";
...
<p className='listFeture'>Compatible with IEEE802.3ae 10GBASE-LR/LW</p>
...
<div className='d-flex felx-wrap justify-content-center'>
 ...
 <p>
NXOSPP-N7-S13-10DRi is a Small Form Factor Pluggable SFP28 transceiver compliant with SFF-8402 SFP28 MSA standard. The high performance uncooled 1310nm DFB
transmitter and high sensitivity PIN receiver with built-in CDR provide superior performance for 10GBASE-LR / 25GBASE-LR Ethernet and CPRI Option #10
applications up to SMF 10km optical links.
...
export default SFP28_25G_LR_DualRate_i;