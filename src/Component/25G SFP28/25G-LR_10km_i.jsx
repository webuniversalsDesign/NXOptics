...
const SFP28_25G_LR_10km_i = () => {
  let PartNumber = "NXOSPP-N7-S13-10DQi";
  let productName = "25G SFP28 LR Transceiver Hot Pluggable, Duplex LC, 1310nm DFB, SMF 10KM, DDM";
...
<div className='d-flex felx-wrap justify-content-center'>
 ...
 <p>
NXOSPP-N7-S13-10DQi is a Small Form Factor Pluggable SFP28 transceiver compliant with SFF-8402 SFP28 MSA standard. The high performance uncooled 1310nm DFB
...
export default SFP28_25G_LR_10km_i;