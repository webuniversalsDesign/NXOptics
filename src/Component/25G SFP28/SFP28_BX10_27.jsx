...
const SFP28_BX10_27 = () => {
  let PartNumber = "NXOSPP-N8-C27-10DQ";
...
<div className='d-flex felx-wrap justify-content-center'>
 ...
 <p>NXOSPP-N8-C27-10DQ is a Small Form Factor Pluggable SFP28 transceiver compliant with SFF-8402 SFP28 MSA standard. The high performance uncooled 1270nm DFB
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-N8-C27-10DQ)</td>
          <td>TOP</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-N8-C27-10DQi)</td>
          <td>TOP</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-N7-M85-10DQ)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>360</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-N7-M85-10DQi)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>400</td>
