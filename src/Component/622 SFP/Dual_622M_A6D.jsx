    ...
    <>
      ...
      <div className='product-struct'>
        ...
        <div className='product-content'>
         ...
         <p className='listFeture'>   Compliant with SONET OC-12 LR-2 and SDH
           STM4 L4.2  </p>
        ...
        <p className='listFeture'>    Link distance 160km(40dB) over SM fiber </p>
