    ...
    <>
      ...
      <div className='product-struct'>
        ...
        <div className='product-content'>
          ...
          <p className='listFeture'>   Compatible with SONET OC-12 IR-2 and SDH </p>
          <p className='listFeture'>  STM-4 S4.2 </p>
        ...
        <div class="tab-content">
          <div id="home" class="container tab-pane active"><br />
            <div class="container mt-3">
              ...
              <p>NXOSFP-B8-S53-20Di Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
