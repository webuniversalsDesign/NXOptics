...
const Dual_622M_60D = () => {
  ...
  let PartNumber = "NXOSFP-B7-S13-60D";
    ...
    <>
      ...
      <div className='product-struct'>
        ...
        <div className='product-content'>
          ...
          <p className='listFeture'>  Compatible with SONET OC-12 LR-1 and SDH STM-4 L4.1</p>
        ...
        <div class="tab-content">
          <div id="home" class="container tab-pane active"><br />
            <div class="container mt-3">
              ...
              <p>NXOSFP-B7-S13-60D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
