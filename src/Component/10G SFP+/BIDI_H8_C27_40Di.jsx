...
const BIDI_H8_C27_40Di = () => { 

  let PartNumber = "NXOSPP-H8-C27-40Di";
  let productName ="10G SFP+ BX(BR)-U Transceiver  Hot Pluggable, Bidi LC, Tx1270nm DFB / Rx1330nm, SMF 40KM, DDM";
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSPP-H8-C27-40D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-H8-C27-40Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H8-C27-40D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>320</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H8-C27-40Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>350</td>
...
export default BIDI_H8_C27_40Di;