...
import dime1 from '../../../img/products/Switches/NXO-100Cdimension.jpg';
...
const NXO_100C = () => { 
  ...
  let PartNumber = "NXO-100C";
  let productName ="1x 10/100Base RJ45 to 1x 100Base Fiber (ST/SC), Compact Size";
...
<h5>Features</h5>
    ...
    <p className='listFeture'>    DC input power 12/24/48VDC (9.6 ~ 60VDC) or 24VAC (18~36VAC) </p>
     <p className='listFeture'>   IP30 rugged metal housing, compact size and fanless </p>
