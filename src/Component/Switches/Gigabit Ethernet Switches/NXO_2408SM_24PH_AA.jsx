...
import productImg1 from '../../../img/products/Switches/Gigabit ethernet switches/NXO-2408SM-24PH-AA.jpg'

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/Switches/NOX-2408SM-24PH_Application.png';
import dime1 from '../../../img/products/Switches/NOX-2408SM-24PH_AA_Dimession.png';
...
const NXO_2408SM_24PH_AA = () => { 

  let PartNumber = "NXO-2408SM-24PH-AA";
  let productName ="24x GbE RJ45 + 8x 100/1000Base SFP with 24x PoE 150W, 110/240VAC  ";
...
<div className='resp-overflow'>
 ...
 <p>{PartNumber} is a rackmount, managed, Industrial Grade, L2 Gigabit PoE (Power over Ethernet) Switch that provides 
  24x 10/100/1000BaseTX PoE ports, plus 8 dual speed (100/1000Base-X) SFP ports, thus providing up to 32 ports total Ethernet
   connectivity. The PoE features enable power and data to be transferred via a single cable, thereby considerably reducing 
   cabling  and electrical wiring expenses. NXO-2408SM-24PH-AA is an ideal solution for applications in Smart City, surveillance, 
   Intelligent traffic  control systems (ITS) and production automation applications. The NXO-2408SM-24PH-AA is designed for harsh 
   outdoor cabinet  applications, with 4kV surge protection, to ensure the uninterrupted reliability of PoE systems. Isolated power 
   inputs also help to increase system reliability and the availability of your network backbone.
...
export default NXO_2408SM_24PH_AA;