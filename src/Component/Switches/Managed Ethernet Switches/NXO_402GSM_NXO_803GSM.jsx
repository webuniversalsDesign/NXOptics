...
import productImg1 from '../../../img/products/Switches/NOX-402GSM.png'
...
const NXO_402GSM_NXO_803GSM = () => { 

  let PartNumber = "NXO+402GSM & NXO+803GSM";
  let productName1 ="4x 10/100Base RJ45 + 2x 100/1000Base SFP  ";
  let productName2 ="8x 10/100Base RJ45 + 3x 100/1000Base SFP  ";
  let productName ="4x 10/100Base RJ45 + 2x 100/1000Base SFP , 8x 10/100Base RJ45 + 3x 100/1000Base SFP  ";
...
<div className='resp-overflow'>
 ...
 <p>{PartNumber} These model are managed industrial grade L2+ switch that provides stable and reliable Ethernet transmission. Housed in rugged DIN  rail or wall mountable enclosures, the switch is designed for harsh environments, such as industrial networks, security automation  applications, intelligent transportation systems (ITS) and is also suitable for many military and utility market applications where  environmental conditions exceed commercial product specifications (See Figure). Standard operating temperature range models (-10  to 60°C) and wide operating temperature range models (-40 to 75°C) fulfill the special needs of industrial automation applications.
...
export default NXO_402GSM_NXO_803GSM;