...
import productImg1 from '../../../img/products/Switches/managed ethernet switches/NXO-402CSW.jpg'

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/Switches/Layer3_NOX-G24044X_Application.png';
import dime1 from '../../../img/products/Switches/NXO_402CSW_Dimenssion.png';
...
const NXO_402CSW = () => { 
  ...
  let PartNumber = "NXO-402CSW";
  let productName ="4x GbE RJ45 + 2x 100/1000 SFP, Compact size";
...
<div className='resp-overflow'>
 ...
 <p>{PartNumber} is a managed industrial grade L2 switch with 4 ports 10/100/1000Base-T 
 and 2 ports 100M/GbE SFP. Housed  in rugged DIN rail or wall mountable enclosures, the 
 switch is designed for harsh environments, such as industrial networking. It is  an ideal 
 solution for Smart City, surveillance, Intelligent traffic control systems, production 
 automation applications. Standard  operating temperature range models (-10 to 60°C) and 
 wide operating temperature range models (-40 to 75°C)
