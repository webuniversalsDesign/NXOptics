...
import productImg1 from '../../../img/products/Switches/NOX-404SM.png'

import Navbar from '../../../Navbar';
import Footer from '../../../Footer';

import Application from '../../../img/products/Switches/NOX-404SM-application.png';
import dime1 from '../../../img/products/Switches/NOX-404SM-dimenssion.png';
...
const NXO_404SM_NXO_803SM = () => { 

  let PartNumber = "NXO+404SM & NXO+803SM";
  let productName1 ="4x GbE RJ45 + 4x 100/1000Base-X SFP  ";
  let productName2 ="8x GbE RJ45 + 3x 100/1000Base-X SFP  ";
  let productName ="4x GbE RJ45 + 4x 100/1000Base-X SFP , 8x GbE RJ45 + 3x 100/1000Base-X SFP  ";
...
<p className='listFeture'>EN62368-1, NEMA-TS2, CE, FCC certified</p>
...
<div className='resp-overflow'>
 ...
 <p>{PartNumber} These models are managed industrial grade GbE L2+ switches with 8/4 10/100/1000Base-T ports plus 3/4 GbE/100M Ethernet SFP  ports that provide stable and reliable Ethernet transmission. Housed in rugged DIN rail or wall mountable enclosures, these switches  are designed for harsh environments, such as industrial networks, security automation applications, intelligent transportation systems  (ITS) and are also suitable for many military and utility market applications where environmental conditions exceed commercial  product specifications (See Figure 1). Standard operating temperature range models (-10 to 60°C) and wide operating temperature  range models (-40 to 75°C) fulfill the special needs of industrial automation applications.
...
export default NXO_404SM_NXO_803SM;