...
const Dual_H7_S15_A0Di = () => {

    let PartNumber = "NXOSPP-H7-S15-A0Di";
    let productName = "10G SFP+ ZR Transceiver Hot Pluggable, Duplex LC, 1550nm EML, SMF 100KM, DDM";
 ...
 */}
                    ...
                    <p className='listFeture'>   OTN OTU2 @10.7G, OTU2e @11.09G OTU2f @11.32G
...
performance for 10GBASE-ZR/ZW applications up to SMF 100km optical links.
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Case Operating Temp. (NXOSPP-H7-S15-A0D)</td>
                                            <td>Top</td>
                                            <td>0</td>
                                            <td>-</td>
                                            <td>+70</td>
                                        ...
                                        <tr>
                                            <td>Case Operating Temp. (NXOSPP-H7-S15-A0Di)</td>
                                            <td>Top</td>
                                            <td>-40</td>
                                            <td>-</td>
                                            <td>+85</td>
                                        ...
                                        <tr>
                                            <td>Supply Current (NXOSPP-H7-S15-A0D)</td>
                                            <td>Icc</td>
                                            <td></td>
                                            <td></td>
                                            <td>550</td>
                                        ...
                                        <tr>
                                            <td>Supply Current (NXOSPP-H7-S15-A0Di)</td>
                                            <td>Icc</td>
                                            <td></td>
                                            <td></td>
                                            <td>680</td>
...
export default Dual_H7_S15_A0Di;