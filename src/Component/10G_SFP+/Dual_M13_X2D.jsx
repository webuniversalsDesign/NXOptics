...
const Dual_M13_X2D = () => { 
  ...
  let PartNumber = "NXOSPP-H7-M13-X2D";
...
<h5>Features</h5>
   ...
   <p className='listFeture'> Compliant with IEEE802.3aq 10GBASE-LRM
 </p>
   ...
   <p className='listFeture'>     Link distance 220m over MM fiber </p>
   <p className='listFeture'>     RoHS Compliant </p>


<h5 className='pt-5'>Applications</h5>

 <p className='listFeture'>  10GBASE-LRM Ethernet @10.3125G</p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSPP-H7-M13-X2D Small Form Factor Pluggable
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-M85-X2D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>320</td>
