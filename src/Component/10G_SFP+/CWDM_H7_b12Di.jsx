...
import productImg1 from '../../img/products/10SFP+/CWDM_1.jpg'
...
const CWDM_H7_b12D = () => { 
  ...
  let PartNumber = "NXOSPP-H7-Cxx-b12Di";
  let productName ="10G SFP+ CWDM Transceiver Hot Pluggable, Duplex LC, CWDM 1270~1450nm DFB, SMF 12dB(20KM), DDM";
...
<h5>Features</h5>
   ...
   <p className='listFeture'> Compliant with IEEE802.3ae 10GBASE-LR/LW
   ...
   <p className='listFeture'>   10 CWDM Wavelength 1270~1450nm available</p>
...
<h5 className='pt-5'>Applications</h5>
 ...
 <p className='listFeture'>  OTN OTU2 @10.7G, OTU2e @11.09G, </p>
  ...
  <p className='listFeture'> 10G DWDM Networks </p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSPP-H7-Cxx-b12Di Small Form Factor Pluggable SFP+ CWDM transceivers are compliant with the current SFP+ Multi-Source Agreement (MSA) Specification. The high performance cooled CWDM EML transmitter and high sensitivity PIN receiver provide superior performance for 10GBASE-LR/LW applications up to SMF 12dB budget optical links.
...
<div id="menu1" class="container tab-pane fade"><br/>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSPP-H7-Cxx-b12D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-H7-Cxx-b12Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-Cxx-b12D
)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-Cxx-b12Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>330</td>
