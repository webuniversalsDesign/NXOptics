...
const Dual_H7_S15_80DMi = () => {

    let PartNumber = "NXOSPP-H7-S15-80DMi";
                    ...
                    <div id="home" class="container tab-pane active"><br />
                        <div class="container mt-3">
                            ...
                            <p>
                                ...
                                performance for 10GBASE-ZR/ZW applications up to SMF 80km optical links
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Case Operating Temp. (NXOSPP-H7-S15-80DM)</td>
                                            <td>Top</td>
                                            <td>0</td>
                                            <td>-</td>
                                            <td>+70</td>
                                        ...
                                        <tr>
                                            <td>Case Operating Temp. (NXOSPP-H7-S15-80DMi)</td>
                                            <td>Top</td>
                                            <td>-40</td>
                                            <td>-</td>
                                            <td>+85</td>
                                        ...
                                        <tr>
                                            <td>Supply Current (NXOSPP-H7-S15-80DM)</td>
                                            <td>Icc</td>
                                            <td></td>
                                            <td></td>
                                            <td>520</td>
                                        ...
                                        <tr>
                                            <td>Supply Current (NXOSPP-H7-S15-80DMi)</td>
                                            <td>Icc</td>
                                            <td></td>
                                            <td></td>
                                            <td>650</td>
...
export default Dual_H7_S15_80DMi;