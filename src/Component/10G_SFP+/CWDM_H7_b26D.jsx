...
const CWDM_H7_b26D = () => { 
  ...
  let PartNumber = "NXOSPP-H7-Cxx-b26D";
...
<h5>Features</h5>
   ...
   <p className='listFeture'>    1470~1610nm cooled CWDM EML laser transmitter
   ...
   <p className='listFeture'>     Link budget 26dB over SM fiber </p>
