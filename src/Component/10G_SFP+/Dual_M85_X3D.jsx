...
import productImg1 from '../../img/products/10SFP+/Dual_2.jpg'
...
const Dual_M85_X3D = () => { 
  ...
  let PartNumber = "NXOSPP-H7-M85-X3D";
  let productName ="10G SFP+ SR Transceiver Hot Pluggable, Duplex LC, 850nm VCSEL, MMF OM3 300M, DDM";
...
<h5>Features</h5>
   ...
   <p className='listFeture'> Compliant with IEEE802.3ae 10GBASE-SR/SW
   ...
   <p className='listFeture'>     Link distance 300m over MM OM3 fiber and 400m over MM OM4 fiber </p>
...
NXOSPP-H7-M85-X3D Small Form Factor Pluggable
...
<div id="menu1" class="container tab-pane fade"><br/>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSPP-H7-M85-X3D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-H7-M85-X3Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-M85-X3D
)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-M85-X3Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
