...
const CWDM_H7_08D = () => { 
  ...
  let PartNumber = "NXOSPP-H7-Cxx-b08D";
...
<h5>Features</h5>
   ...
   <p className='listFeture'>      Uncooled CWDM DFB laser transmitter and PIN  receiver
</p>
   ...
   <p className='listFeture'>     Link distance 10km over SM fiber for  1270~1570nm</p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSPP-H7-Cxx-b08D Small Form Factor Pluggable  SFP+ CWDM transceivers are compliant with the  current SFP+ Multi-Source Agreement (MSA)  Specification. The high performance cooled CWDM  EML transmitter and high sensitivity PIN receiver  provide superior performance for 10GBASE-LR/LW  applications up to SMF 8dB budget optical links.
