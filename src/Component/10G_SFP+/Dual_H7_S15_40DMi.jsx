...
import productImg1 from '../../img/products/10SFP+/Dual_4.jpg'
...
const Dual_H7_S15_40DMi = () => { 

  let PartNumber = "NXOSPP-H7-S15-40DMi";
...
<h5>Features</h5>
   ...
   <p className='listFeture'>Compatible with IEEE802.3ae 10GBASE-ER/EW
 </p>
...
high sensitivity PIN receiver provide superior performance for Multi-Rate applications up to
SMF 40km optical links.
...
export default Dual_H7_S15_40DMi;