...
import productImg1 from '../../img/products/10SFP+/Tunable1.jpg'
...
import machdimenssion from '../../img/products/10SFP+/Tunable1_Dimension.jpg';
...
<h5>Features</h5>
 ...
 <p className='listFeture'>   Compliant with 10GBase-ZR/ZW </p>
 <p className='listFeture'>   Compliant with SONET OC192/ SDH STM64 with ITU-T G.709 and G.959.1 P1L1-2D2 </p>
 <p className='listFeture'>   Compliant with SFF-8431 SFP+ MSA </p>
 <p className='listFeture'>   Hot Pluggable </p>
  <p className='listFeture'>  50GHz ITU Grid channel spacing with integrated wavelength locker </p>
 <p className='listFeture'>   Monolithically integrated full C-band DWDM tunable transmitter </p>
...
<p className='listFeture'>    2-wire interface for management and diagnostic monitor compliant with SFF-8472 </p>
 <p className='listFeture'>   Low power consumption less than 1.85W </p>
...
10GBase-ZR/ZW, 10G Fiber Channel and SONET/SDH applications up to SMF 80km optical links.
...
export default Tunable_10G_SFP_DWDM;