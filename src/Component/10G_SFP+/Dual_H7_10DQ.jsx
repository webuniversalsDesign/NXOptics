...
// import Memorymap2 alt='img-not-found'from '../../img/products/1.25G CSFP/memoryMap2.png';
...
const Dual_H7_10DQ = () => { 
  ...
  let PartNumber = "NXOSPP-H7-S13-10DQ";
...
<h5>Features</h5>
   ...
   <p className='listFeture'>     Compliant with CPRI Option 8
...
NXOSPP-H7-S13-10DQ Small Form Factor Pluggable
