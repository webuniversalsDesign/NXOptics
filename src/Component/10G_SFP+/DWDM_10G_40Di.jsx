...
// import transcrvealt='img-not-found' from '../../img/products/100G CFP CFP2 CFP4/Transceiver.jpg';
...
const DWDM_10G_40Di = () => { 
  ...
  let PartNumber = "NXOSPP-H7-Dxx-40Di";
  let productName ="10G SFP+ DWDM Transceiver Hot Pluggable, Duplex LC, 100GHz DWDM EML, SMF 40KM, DDM";
...
<div id="menu1" className="container tab-pane fade"><br/>
 ...
 <div id="menu2" className="container tab-pane fade"><br/>
  ...
  <table className="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSPP-H7-Dxx-40D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-H7-Dxx-40Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-Dxx-40D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>500</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-Dxx-40Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>500</td>
