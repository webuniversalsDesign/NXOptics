...
const CWDM_H7_80Di = () => { 
  ...
  let PartNumber = "NXOSPP-H7-Cxx-80Di";
  let productName ="10G SFP+ CWDM Transceiver Hot Pluggable, Duplex LC, CWDM 1470~1610nm EML, SMF 80KM, DDM";
...
<h5>Features</h5>
   ...
   <p className='listFeture'> Compliant with 10GBASE-ZR/ZW
 </p>
   ...
   <p className='listFeture'>    1470~1610nm cooled CWDM EML laser transmitter</p>
...
<h5 className='pt-5'>Applications</h5>
 ...
 <p className='listFeture'>  10GBASE-ZR/ZW Ethernet @10.3125G
 </p>
...
<div id="menu1" class="container tab-pane fade"><br/>
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSPP-H7-Cxx-80D )</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSPP-H7-Cxx-80D i)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-Cxx-80D 
)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
        ...
        <tr>
          <td>Supply Current (NXOSPP-H7-Cxx-80D i)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>650</td>
