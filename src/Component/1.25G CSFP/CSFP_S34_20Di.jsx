...
const CSFP_S34_20Di = () => { 
  ...
  let PartNumber = "NXOSFP-CC-S34-20Di";
  let productName ="1.25G CSFP 1000BX-U Compact 2CH Bidi Transceiver  Hot Pluggable, Dual Bidi LC, Tx1310nm FP / Rx1490nm, SMF 20KM, DDM";
...
<p className='listFeture'>Compliant with IEEE802.3ah 1000BASE-BX10-D</p>
...
<p className='listFeture'>2CH Bidi unit with 1310nm FP laser transmitter and 1490nm PIN receiver</p>
...
<div className='resp-overflow'>
 ...
 <p>{PartNumber} Small Form Factor Pluggable CSFP transceivers are compliant with the current CSFP
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-CC-S34-20D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-CC-S34-20Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-CC-S34-20D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>450</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-CC-S34-20Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>500</td>
