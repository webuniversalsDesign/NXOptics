...
const G200_QSFP_DD_ER4 = () => {

  let productName = "200GBase-NXOQSFP-DD ER4 Transceiver (SMF, 1310nm,40km,LC) Transceiver";
  let PartNumber = "NXOQSFP-DD ER4";
...
<div className='container-fluid'>
  <div className='row'>
    <div className='col-12 pb-3'>
      ...
      <p className='listFeture'>	Supports 200GBASE-ER4</p>
<p className='listFeture'>	Lane bit rate 53.125 Gb/s with PAM4</p>
<p className='listFeture'>	Up to 40km transmission on SMF</p>
<p className='listFeture'>	LAN WDM laser and APD receiver</p>
...
<p className='listFeture'>	Compliant with IEEE 802.3cn 200GBASE-ER4</p>
...
export default G200_QSFP_DD_ER4;