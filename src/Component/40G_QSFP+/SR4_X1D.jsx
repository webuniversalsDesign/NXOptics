...
const SR4_X1D = () => {
  ...
  let PartNumber = "NXOQFP-I9-M85-X1D";
...
<Link className='btn-buy_now' data-bs-toggle="modal" data-bs-target="#myModal"><BsCartCheck style={{marginBottom:"5px"}}/> Enquire Now</Link>
</div>
...
<div className='sell-text'>NXOQFP-I9-M85-X1D
...
<div className='d-flex felx-wrap justify-content-center'>
 ...
 <p>NXOQFP-I9-M85-X1D is a Four-Channel Parallel Fibers QSFP+ transceiver for 40GbE and InfiniBand QDR, application especially in Data Center & Storage networks. The QSFP full-duplex optical module with MPO-12 receptacle offers 4 independent transmitter and receiver channels each capable of 10.3125Gbps operation for an aggregate data rate of 41.25Gbps up to MMF OM3 300m optical links.
</p>
</div>
</div>
