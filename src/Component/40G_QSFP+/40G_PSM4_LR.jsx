...
<h4>
40G QSFP+ PSM4 LR Transceiver
Hot Pluggable, MPO / MTP, 1310nm DFB, SMF 10KM, DDM
</h4>
...
<p className='listFeture'>Breakout to 4 x 10GBASE-LR Ethernet</p>
<p className='listFeture'>InfiniBand DDR, QDR, SDR interconnects</p>
