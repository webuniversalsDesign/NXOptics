...
const BIDI_C8_S45_A0Di = () => { 

  let PartNumber = "NXOSFP-C8-S45-A0Di";
  let productName ="1.25G SFP 1000BX-U Transceiver Hot Pluggable, Bidi LC, Tx1490nm DFB / Rx1550nm, SMF 100KM, DDM";
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C8-S45-A0D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C8-S45-A0Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C8-S45-A0D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C8-S45-A0Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
...
export default BIDI_C8_S45_A0Di;