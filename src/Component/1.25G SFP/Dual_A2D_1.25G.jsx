...
const Dual_A2D_1_25G = () => { 

  let PartNumber = "NXOSFP-C7-S15-A2D";
  let productName ="1.25G SFP 1000BASE-EZX Transceiver Hot Pluggable, Duplex LC, 1550nm DFB, SMF 120KM, DDM";
...
<p className='listFeture'>Gigabit Ethernet 1000BASE-EZX @1.25G</p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSFP-C7-S15-A2D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
...
performance for Gigabit Ethernet 1000BASE-EZX and
Fiber Channel 1GFC applications up to SMF 120km optical links.
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C7-S15-A2D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C7-S15-A2Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-S15-A2D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>290</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-S15-A2Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>320</td>
