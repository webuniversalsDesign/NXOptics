...
// import transcrve from '../../i alt='img-not-found'mg/products/100G CFP CFP2 CFP4/Transceiver.jpg';
import pinassisment from '../../img/products/2.5_SFP/CWDM_PinAssignment.jpg';
import machdimenssion from '../../img/products/1.25G SFP/mechDimenssion.png';
import Memorymap from '../../img/products/2.5_SFP/CWDM_MemoryMap.jpg';
// import Memorymap2 from '../../img alt='img-not-found'/products/1.25G CSFP/memoryMap2.png';
...
const SFP_1_25G_DWDM_80Di = () => { 

  let PartNumber = "NXOSFP-C7-Dxx-80Di";
...
<div className='resp-overflow'>
 ...
 {PartNumber} Small Form Factor Pluggable SFP transceivers are compliant with the current SFP Multi-Source Agreement (MSA) Specification. There are 45 channels ITU-T 100GHz C-Band DWDM wavelengths available from 1528.77nm(CH61) to 1563.86nm(CH17). The high performance Cooled
 ...
 <div id="menu2" className="container tab-pane fade"><br/>
  ...
  <div className="table-responsive">
    <table className="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C7-Dxx-80D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C7-Dxx-80Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-Dxx-80D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>600</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-Dxx-80Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>750</td>
...
export default SFP_1_25G_DWDM_80Di;