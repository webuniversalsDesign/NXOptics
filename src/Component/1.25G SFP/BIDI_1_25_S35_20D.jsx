...
import machdimenssion from '../../img/products/1.25G SFP/mechDimenssion2.jpg.png';
...
const BIDI_1_25_S35_20D = () => { 

  let PartNumber = "NXOSFP-C2-S35-20D";
...
<div className='resp-overflow'>
 ...
 <p>
NXOSFP-C2-S35-20D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C7-S35-20D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C7-S35-20Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-S35-20D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-S35-20Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>280</td>
...
export default BIDI_1_25_S35_20D;