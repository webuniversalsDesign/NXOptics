...
const BIDI_C8_S54_80D = () => { 

  let PartNumber = "NXOSFP-C8-S54-80D";
  let productName ="1.25G SFP 1000BX-D Transceiver Hot Pluggable, Bidi LC, Tx1550nm DFB / Rx1490nm, SMF 80KM, DDM";
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSFP-C8-S54-80D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C8-S54-80D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C8-S54-80Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C8-S54-80D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>270</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C8-S54-80Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>300</td>
...
export default BIDI_C8_S54_80D;