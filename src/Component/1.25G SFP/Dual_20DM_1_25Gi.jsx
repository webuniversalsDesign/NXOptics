...
const Dual_20DM_1_25Gi = () => { 

  let PartNumber = "NXOSFP-C7-S13-20DMi";
  let productName ="1.25G SFP 1000BASE-LX Transceiver Hot Pluggable, Duplex LC, 1310nm FP, SMF 20KM, DDM, Multi-Rate";
...
<p className='listFeture'>Compatible with IEEE802.3ah Fast Ethernet</p>
<p className='listFeture'>Compatible with SONET OC-12 IR1 and SDH STM-4 S4.1</p>
<p className='listFeture'>Compatible with SONET OC-3 IR1 and SDH STM-1 S1.1</p>
...
<p className='listFeture'>Fast Ethernet 100BASE-LX10 @125M</p>
...
Ethernet 1000BASE-LX and Fiber Channel 1GFC applications up to SMF 10km optical links.
...
export default Dual_20DM_1_25Gi;