...
import machdimenssion from '../../img/products/1.25G SFP/M53_X5D_mechDimenssion.jpg';
...
const BIDI_1_25_M53_X5Di = () => { 

  let PartNumber = "NXOSFP-C8-M53-X5Di  ";
  let productName ="1.25G SFP 1000BX-D Transceiver Hot Pluggable, Bidi LC, Tx1550nm FP / Rx1310nm, MMF 500M, DDM";
...
<p className='listFeture'>Compliant with IEEE802.3ah 1000BASE-BX-D
</p>
<p className='listFeture'>Compliant with Fiber Channel 100-M5-SN-I
</p>
<p className='listFeture'>Compliant with INF-8074i SFP MSA</p>
<p className='listFeture'>Hot Pluggable</p>
<p className='listFeture'>1550nm FP laser transmitter
</p>
<p className='listFeture'>Simplex SC connector
</p>
<p className='listFeture'>2-wire interface for management and diagnostic monitor compliant with SFF-8472</p>
<p className='listFeture'>Single +3.3V power supply</p>
<p className='listFeture'>Link distance 500m over SM fiber</p>
...
Fiber Channel 1GFC applications up to MMF 500m optical links.
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C8-M53-X5D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C8-M53-X5Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C8-M53-X5D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C8-M53-X5Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>280</td>
...
export default BIDI_1_25_M53_X5Di;