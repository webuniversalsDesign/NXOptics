...
const Dual_40D_1_25G = () => { 

  let PartNumber = "NXOSFP-C7-S13-40D";
  let productName ="1.25G SFP 1000BASE-LHX(EX) Transceiver Hot Pluggable, Duplex LC, 1310nm DFB, SMF 40KM, DDM";
...
<p className='listFeture'>Compliant with Fiber Channel 100-SM-LC-L</p>
...
<div className='resp-overflow'>
 ...
 <p>
 NXOSFP-C7-S13-40D Small Form Factor Pluggable SFP transceivers are compliant with the current SFP
...
performance for Gigabit Ethernet 1000BASE-LHX(EX)
and Fiber Channel 1GFC applications up to SMF 40km optical links.
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOSFP-C7-S13-40D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOSFP-C7-S13-40Di)</td>
          <td>Top</td>
          <td>-40</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-S13-40D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>250</td>
        ...
        <tr>
          <td>Supply Current (NXOSFP-C7-S13-40Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>280</td>
