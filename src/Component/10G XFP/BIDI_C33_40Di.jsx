...
const BIDI_C33_40Di = () => { 
  ...
  let PartNumber = "NXOXFP-H8-C33-X40Di";
  let productName ="10G XFP BX(BR)-D TransceiverHot Pluggable, Bidi LC, Tx1330nm DFB / Rx1270nm, SMF 40KM, DDM";
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOXFP-H8-C33-X40D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOXFP-H8-C33-X40Di)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOXFP-H8-C33-X40D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>460</td>
        ...
        <tr>
          <td>Supply Current (NXOXFP-H8-C33-X40Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>520</td>
        ...
        <tr>
          <td>Power Consumption (NXOXFP-H8-C33-X40D)</td>
          <td>P</td>
          <td></td>
          <td></td>
          <td>1.6</td>
        ...
        <tr>
          <td>Power Consumption (NXOXFP-H8-C33-X40Di)</td>
          <td>P</td>
          <td></td>
          <td></td>
          <td>1.8</td>
