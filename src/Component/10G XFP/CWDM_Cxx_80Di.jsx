...
const CWDM_Cxx_80Di = () => { 
  ...
  let PartNumber = "NXOXFP-H7-Cxx-X80Di";
...
<p className='listFeture'>Support 9.953Gb/s to 11.32Gb/s</p>
...
performance cooled CWDM EML transmitter and high sensitivity APD receiver provide superior performance for 10GBASE-ZR/ZW applications up to SMF 80km optical links.
