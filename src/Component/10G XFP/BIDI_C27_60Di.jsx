...
const BIDI_C27_60Di = () => { 
  ...
  let PartNumber = "NXOXFP-H8-C27-X60Di";
  let productName ="10G XFP BX(BR)-U Transceiver Hot Pluggable, Bidi LC, Tx1270nm DFB / Rx1330nm, SMF 60KM, DDM";
...
Multi-Source Agreement (MSA) Specification. The high performance uncooled 1270nm DFB transmitter and high sensitivity APD receiver provide superior
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOXFP-H8-C27-60D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOXFP-H8-C27-60Di)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOXFP-H8-C27-60D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>500</td>
        ...
        <tr>
          <td>Supply Current (NXOXFP-H8-C27-60Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>600</td>
        ...
        <tr>
          <td>Power Consumption (NXOXFP-H8-C27-60D)</td>
          <td>P</td>
          <td></td>
          <td></td>
          <td>1.8</td>
        ...
        <tr>
          <td>Power Consumption (NXOXFP-H8-C27-60Di)</td>
          <td>P</td>
          <td></td>
          <td></td>
          <td>2.1</td>
