...
import productImg1 from '../../img/products/10G XFP/C55_80D.jpg'
...
import machdimenssion from '../../img/products/10G XFP/dimension80D.jpg';
...
const BIDI_C55_80Di = () => { 
  ...
  let PartNumber = "NXOXFP-H8-C55-X80Di";
  let productName ="10G XFP BX(BR)-D Transceiver Hot Pluggable, Bidi LC, Tx1550nm EML / Rx1490nm, SMF 80KM, DDM";
...
<h5>Features</h5>
    ...
    <p className='listFeture'>        Hot Pluggable XFP footprint </p>
       <p className='listFeture'>     Cooled 1550nm EML laser transmitter </p>
...
Multi-Source Agreement (MSA) Specification. The high performance cooled 1550nm EML transmitter and high sensitivity APD receiver provide superior performance for 10GBASE Ethernet applications up to 80km optical links.
 ...
 <div id="menu2" class="container tab-pane fade"><br/>
  ...
  <div class="table-responsive">
    <table class="table table-hover">
      ...
      <tr>
          <td>Case Operating Temp. (NXOXFP-H8-C55-X80D)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+70</td>
        ...
        <tr>
          <td>Case Operating Temp. (NXOXFP-H8-C55-X80Di)</td>
          <td>Top</td>
          <td>0</td>
          <td>-</td>
          <td>+85</td>
        ...
        <tr>
          <td>Supply Current (NXOXFP-H8-C55-X80D)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>750</td>
        ...
        <tr>
          <td>Supply Current (NXOXFP-H8-C55-X80Di)</td>
          <td>Icc</td>
          <td></td>
          <td></td>
          <td>900</td>
        ...
        <tr>
          <td>Power Consumption (NXOXFP-H8-C55-X80D)</td>
          <td>P</td>
          <td></td>
          <td></td>
          <td>2.6</td>
        ...
        <tr>
          <td>Power Consumption (NXOXFP-H8-C55-X80Di)</td>
          <td>P</td>
          <td></td>
          <td></td>
          <td>3.2</td>
