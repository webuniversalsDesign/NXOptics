...
const Dual_H7_S15_80D_L_SFP = () => { 

  let PartNumber = "NXOXFP-H7-S15-X80D-L";
...
<p className='listFeture'>Compliant with SONET OC192/ SDH STM64 with ITU-T G.709</p>
<p className='listFeture'>Compliant with SONET OC192/ SDH STM64 ITU-T G.959.1 P1L1-2D2</p>
...
<p className='listFeture'>Link length for 80km over SM fiber</p>
<p className='listFeture'>Low power consumption {'(<2.0W)'}</p>
<p className='listFeture'>Rx Protection with MAX Input {'Power<-3dBm'}</p>
<p className='listFeture'>RoHS compliant</p>

<h5 className='pt-5'>Applications</h5>

<p className='listFeture'>10GBASE-ZR/ZW Ethernet</p>
...
Multi-Source Agreement ( MSA ) Specification. The high performance cooled 1550nm EML transmitter & high sensitivity APD receiver provide superior performance for 10GBase-ZR/ZW, SONET OC192/ SDH STM64 and
10GFiber Channel applications up to 80km optical links. With advanced design, it realized Low Power Consumption {'<2.0W'}.
...
export default Dual_H7_S15_80D_L_SFP;